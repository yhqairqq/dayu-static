...
export default class Tokenizer {
  ...
  tokenize(input) {
    ...
    while (localInput.length) {
      ...
      token = this.getNextToken(localInput, token);
      // Advance the string
      localInput = localInput.substring(token.value.length);
  ...
  getNextToken(input, previousToken) {
    return (
      ...
      this.getMyOpenParenToken(input) ||
      this.getMyCloseParenToken(input) ||
